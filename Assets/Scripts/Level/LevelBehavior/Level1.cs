...
namespace Game.Level
{
    public class Level1 : LevelBehaviorTree
    {
        ...
        {
            return Selector(
                () => Condition(currentTime > 2.5f && currentTime < 7.5f,
                    () => Selector(
                        () => Condition(currentTime > 3f && !targetTime[3f], Second3Action),
                ...
                () => Condition(currentTime > 7.5f && currentTime < 10f,
                    () => Selector(
                        () => Condition(currentTime > 7.5f && !targetTime[7.5f], Secon7p5Action),
                        () => Condition(currentTime > 8f && !targetTime[8f], Second8Action)
                    )),
                () => Condition(currentTime > 10f && currentTime < 17f,
                    () => Selector(
                        () => Condition(currentTime > 10.25f && !targetTime[10.25f], Second10p25Action),
                        () => Condition(currentTime > 10.5f && !targetTime[10.5f], Second10p5Action),
                        () => Condition(currentTime > 11f && !targetTime[11f], Secon11Action),
                        () => Condition(currentTime > 11.5f && !targetTime[11.5f], Second11p5Action),
                        () => Condition(currentTime > 12f && !targetTime[12f], Second12Action),
                        () => Condition(currentTime > 12.5f && !targetTime[12.5f], Second12p5Action),
                        () => Condition(currentTime > 13f && !targetTime[13f], Second13Action),
                        () => Condition(currentTime > 13.5f && !targetTime[13.5f], Second13p5Action),
                        () => Condition(currentTime > 14f && !targetTime[14f], Second14Action),
                        () => Condition(currentTime > 16f && !targetTime[16f], Second16Action)
                    )),
                () => Condition(currentTime > 17.5f && currentTime < 21f,
                    () => Selector(
                        () => Condition(currentTime > 17.5f && !targetTime[17.5f], Second17p5Action),
                        () => Condition(currentTime > 18f && !targetTime[18f], Second18Action),
                        () => Condition(currentTime > 18.5f && !targetTime[18.5f], Second18p5Action),
                        () => Condition(currentTime > 19f && !targetTime[19f], Second19Action),
                        () => Condition(currentTime > 20f && !targetTime[20f], Second20Action)
                    )),
                () => Condition(currentTime > 21f && currentTime < 26f,
                    () => Selector(
                ...
                () => Condition(currentTime > 26f && currentTime < 30f,
                    () => Selector(
                ...
                () => Condition(currentTime > 30f && currentTime < 36f,
                    () => Selector(
                        () => Condition(currentTime > 30f && !targetTime[30f], Second30Action),
                ...
                () => Condition(currentTime > 36f && currentTime < 43f,
                    () => Selector(
                        ...
                        () => Condition(currentTime > 38f && !targetTime[38f], Second38Action),
                        () => Condition(currentTime > 39f && !targetTime[39f], Second39Action),
                        () => Condition(currentTime > 39.5f && !targetTime[39.5f], Second39p5Action),
                        () => Condition(currentTime > 40.5f && !targetTime[40.5f], Second40p5Action),
                        () => Condition(currentTime > 41f && !targetTime[41f], Second41Action)
                    ))
            );
        }
        ...
        private Action Second10p25Action()
        {
            targetTime[10.25f] = true;
            SpikeFlash1(0, 0, 0);
            SpikeFlash1(1, 1, 0);
            SpikeFlash1(2, 2, 0);
            SpikeFlash1(3, 3, 0);
        ...
        private Action Second12p5Action()
        {
            targetTime[12.5f] = true;
            SpikeWarn(4, 0, 1);
            SpikeWarn(10, 0, 1);
            return null;
        }
        ...
        private Action Second13p5Action()
        {
            targetTime[13.5f] = true;
            SpikeWarn(6, 0, 1);
            SpikeWarn(8, 0, 1);
            return null;
        }
        ...
        private Action Second40p5Action()
        {
            targetTime[40.5f] = true;
            SpikeWarn(6, 0, 1);
            SpikeWarn(7, 0, 1);
            return null;
        }

        private Action Second41Action()
        {
            targetTime[41f] = true;
            SpikeMove(6, 1f, 0, 1);
            SpikeMove(7, 1f, 0, 1);
