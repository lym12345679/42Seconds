...
namespace Game.Level
{
    public class TestLevel0 : LevelBehaviorTree
    {
            ...
            return Selector(
                () => Condition(currentTime >= 3f && currentTime < 5f,
                    () => Selector(
                        ...
                        () => Condition(currentTime > 3.25f && seconds3 && !seconds3p25, () => { return Second3p25Action(); }),
                        () => Condition(currentTime > 3.5f && seconds3p25 && !seconds3p5, () => { return Second3p5Action(); }),
                        () => Condition(currentTime > 3.75f && seconds3p5 && !seconds3p75, () => { return Second3p75Action(); }),
                        () => Condition(currentTime > 4f && seconds3p75 && !seconds4, () => { return Second4Action(); }),
                        () => Condition(currentTime > 4.25f && seconds4 && !seconds4p25, () => { return Second4p25Action(); }),
                        () => Condition(currentTime > 4.5f && seconds4p25 && !seconds4p5, () => { return Second4p5Action(); }),
                        () => Condition(currentTime > 4.75f && seconds4p5 && !seconds4p75, () => { return Second4p75Action(); })
                    )),
                ...
                () => Condition(currentTime >= 13f && currentTime < 15f,
                    () => Selector(
                        ...
                        () => Condition(currentTime > 14f && seconds13 && !seconds14, () => { return Second14Action(); }),
                        () => Condition(currentTime > 14.75f && seconds14 && !seconds14p75, () => { return Second14p75Action(); })
                    )),
                () => Condition(currentTime >= 15f && currentTime < 17f,
                    () => Selector(
                        () => Condition(!seconds15, () => { return Second15Action(); }),
                        () => Condition(currentTime > 15.25f && seconds15 && !seconds15p25, () => { return Second15p25Action(); }),
                        () => Condition(currentTime > 15.5f && seconds15p25 && !seconds15p5, () => { return Second15p5Action(); }),
                        () => Condition(currentTime > 15.75f && seconds15p5 && !seconds15p75, () => { return Second15p75Action(); }),
                        () => Condition(currentTime > 16f && seconds15p75 && !seconds16, () => { return Second16Action(); }),
                        () => Condition(currentTime > 16.25f && seconds16 && !seconds16p25, () => { return Second16p25Action(); }),
                        () => Condition(currentTime > 16.5f && seconds16p25 && !seconds16p5, () => { return Second16p5Action(); }),
                        () => Condition(currentTime > 16.75f && seconds16p5 && !seconds16p75, () => { return Second16p75Action(); })
                    )),
                () => Condition(currentTime >= 17f && currentTime < 22f,
                    () => Selector(
                        () => Condition(!seconds17, () => { return Second17Action(); }),
                        () => Condition(currentTime > 17.25f && seconds17 && !seconds17p25, () => { return Second17p25Action(); }),
                        () => Condition(currentTime > 17.5f && seconds17p25 && !seconds17p5, () => { return Second17p5Action(); }),
                        () => Condition(currentTime > 17.75f && seconds17p5 && !seconds17p75, () => { return Second17p75Action(); }),
                        () => Condition(currentTime > 18f && seconds17p75 && !seconds18, () => { return Second18Action(); }),
                        () => Condition(currentTime > 18.25f && seconds18 && !seconds18p25, () => { return Second18p25Action(); }),
                        () => Condition(currentTime > 18.5f && seconds18p25 && !seconds18p5, () => { return Second18p5Action(); }),
                        () => Condition(currentTime > 19f && seconds18p5 && !seconds19, () => { return Second19Action(); }),
                        () => Condition(currentTime > 20.5f && seconds19 && !seconds20p5, () => { return Second20p5Action(); })
                    )),
                () => Condition(currentTime >= 22f && currentTime < 34f,
                    () => Selector(
                        () => Condition(!seconds22, () => { return Second22Action(); }),
                        () => Condition(currentTime > 23f && seconds22 && !seconds23, () => { return Second23Action(); }),
                        () => Condition(currentTime > 24f && seconds23 && !seconds24, () => { return Second24Action(); }),
                        () => Condition(currentTime > 25f && seconds24 && !seconds25, () => { return Second25Action(); }),
                        () => Condition(currentTime > 26f && seconds25 && !seconds26, () => { return Second26Action(); }),
                        () => Condition(currentTime > 27f && seconds26 && !seconds27, () => { return Second27Action(); }),
                        () => Condition(currentTime > 28f && seconds27 && !seconds28, () => { return Second28Action(); }),
                        () => Condition(currentTime > 29f && seconds28 && !seconds29, () => { return Second29Action(); }),
                        () => Condition(currentTime > 30f && seconds29 && !seconds30, () => { return Second30Action(); }),
                        () => Condition(currentTime > 31f && seconds30 && !seconds31, () => { return Second31Action(); }),
                        () => Condition(currentTime > 32f && seconds31 && !seconds32, () => { return Second32Action(); })
                    )),
                () => Condition(currentTime >= 33f && currentTime < 39f,
                    () => Selector(
                        () => Condition(!seconds33, () => { return Second33Action(); }),
                        () => Condition(currentTime > 34f && seconds33 && !seconds34, () => { return Second34Action(); }),
                        () => Condition(currentTime > 35f && seconds34 && !seconds35, () => { return Second35Action(); }),
                        () => Condition(currentTime > 36f && seconds35 && !seconds36, () => { return Second36Action(); }),
                        () => Condition(currentTime > 37f && seconds36 && !seconds37, () => { return Second37Action(); }),
                        () => Condition(currentTime > 38f && seconds37 && !seconds38, () => { return Second38Action(); })
                    )),
        ...
        {
            spikeList[n].Move(new Vector2(0, 1), 0.5f, PositionEffectMode.PingPong, SpikePersentageHanderEnum.X2, (e) =>
            {
                e.Stop();
            });
        }
        ...
        {
            spikeList[n].Move(new Vector2(0, 1), 0.5f, PositionEffectMode.PingPong, SpikePersentageHanderEnum.X, (e) =>
            {
                e.Stop();
            });
        }
